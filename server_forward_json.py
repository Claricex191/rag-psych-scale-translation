...
class Rag_server:
    def __init__(self, use_memory: bool = False, anthropic_api_key: Optional[str] = None,
        ...
        if use_memory:
            ...
            try:
                self.qdrant_client = QdrantClient(path="/project/def-fji/rag_server/qdrant-db")
                logger.info("Using embedded Qdrant at /project/def-fji/rag_server/qdrant-db")
...
def main(use_memory: bool, port: int, host: str) -> int:
    ...
    async def upload_endpoint(request: Request):
        ...
        pdf_dir = "/project/def-fji/rag_server/pdfs"
